...
<td width="1%">&nbsp;</td>
<td>
<?php echo form::getform('parentid',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('顶级分类可跳过！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
...
<span class="hotspot" onmouseover="tooltip.show('填写分类名称！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
</td>
</tr>
 ...
 <tr>
      ...
      <td width="1%">&nbsp;</td>
      <td align="left"><input type="text" class="input" name="subtitle" id="subtitle" /><span class="hotspot" onmouseover="tooltip.show('分类自定义副标题！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span></td>
    </tr>
...
<span class="hotspot" onmouseover="tooltip.show('目录必须是英文名，留空则自动使用拼音名！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
</td>
</tr>
</table>
...
<td width="1%">&nbsp;</td>
<td>
<?php echo form::getform('meta_title',$form,$field,$data);?>
...
<span class="hotspot" onmouseover="tooltip.show('默认：<b>{</b>$caturl<b>}</b>/type_<b>{</b>$page<b>}</b>.html！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
</tr>
...
<span class="hotspot" onmouseover="tooltip.show('被调用的格式：type<b>(</b>$typeid,&prime;标记&prime;<b>)</b>;！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
