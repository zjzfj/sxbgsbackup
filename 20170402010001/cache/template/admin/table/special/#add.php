...
<?php echo form::getform('title',$form,$field,$data);?>
 ...
 <tr>
      ...
      <td width="1%">&nbsp;</td>
      <td align="left"><input type="text" class="input" name="subtitle" id="subtitle" /><span class="hotspot" onmouseover="tooltip.show('专题自定义副标题！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span></td>
    </tr>
