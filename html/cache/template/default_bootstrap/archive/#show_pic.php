...
<a href="<?php echo $pic['url'];?>" rel="lightbox[roadtrip]"><img src="<?php echo $pic['url'];?>" alt="<?php echo $pic['alt'];?>" class="img-responsive" onerror='this.src="<?php echo config::get('onerror_pic');?>"' /></a>
</div>
<?php } ?>
</div>
<!-- 左右按钮 -->
