...
<link title="skin2" href="<?php echo $skin_path;?>/css/admin_style_b.css" type="text/css" rel="stylesheet"/>
<link title="skin3" href="<?php echo $skin_path;?>/css/admin_style_c.css" type="text/css" rel="stylesheet"/>
...
<!-- 头部 -->
<div class="icons">
<a onclick="setActiveStyleSheet('skin1'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_1.gif" /></a>
<a onclick="setActiveStyleSheet('skin2'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_2.gif" /></a>
<a onclick="setActiveStyleSheet('skin3'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_3.gif" /></a>

</div> 

<div class="box">
<div id="header">
<a href="<?php echo $base_url;?>/"><img src="<?php echo $skin_path;?>/images/logo.png" class="logo" /></a>
<div class="top_right">
<ul>
...
<script type="text/javascript" src="<?php echo $skin_path;?>/js/styleswitcher.js"></script>
</body>
</html>