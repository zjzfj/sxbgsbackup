...
<td width="50%" style="padding-left:10px;"><strong><?php echo $d['name'];?></strong>
<span class="hotspot" onmouseover="tooltip.show('<?php echo $d['desc'];?>');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
<td align="center"><?php echo cut($d['website']);?></td>
<td align="center"><?php echo cut($d['version']);?></td>
