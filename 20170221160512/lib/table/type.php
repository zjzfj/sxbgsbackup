...
class type extends table {
    ...
    function getcols($act) {
        if ($act == 'modify')
            return 'typeid,parentid,typename,htmldir,template,listtemplate,showtemplate,ishtml,isshow,ispages,includecatarchives,linkto,htmlrule,listhtmlrule,showhtmlrule,description,keyword,stype,thumb,thumb_width,thumb_height';
