...
<strong>MySQL设置  <?php if($mysql_pass) { ?><span style="color:#FFFFFF;">( <?php echo helper::yes(1); ?> <font color="white">连接成功!</font> )</span><?php } else { ?><?php if(get('submit')) { ?><span style="color:red;">( <?php echo helper::yes(0); ?> 连接失败！)<?php } else { ?>( 未测试连接！ )<?php } ?><?php } ?></span></strong>
