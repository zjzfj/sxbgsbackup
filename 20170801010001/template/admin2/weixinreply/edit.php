  ...
  <div id="tagscontent" class="right_box">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
      <tr class="s_out" >
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="keyword" id="keyword" value="{$data[keyword]}" class="input" /></td>
      </tr>
      <tr class="s_out" >
        <td width="19%" align="right">完整词</td>
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="word" id="word" value="{$data[word]}" class="input" /></td>
      </tr>
      <tr class="s_out" >
