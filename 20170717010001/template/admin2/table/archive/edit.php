...
<?php echo form::select('spid',
    ...
    <tr>
		...
		<input id="color" name="color" type="hidden" /><span class="hotspot" onmouseover="tooltip.show('标题文字颜色！');" onmouseout="tooltip.hide();"><img id="color_btn" width="14" height="14" src="images/admin/colorpicker.png" style="cursor:pointer;" /></span>  <span class="hotspot" onmouseover="tooltip.show('标题加粗！');" onmouseout="tooltip.hide();"><input name="strong" type="checkbox" value="1" {if $data['strong']==1}checked{/if} /></span>
		</td>
    </tr>
	<tr>
