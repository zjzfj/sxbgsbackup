...
<td align="center" width="70">
					...
					<span class="hotspot" onmouseover="tooltip.show('查看网站前台动态页面，<br />可方便的观察修改后的效果！');" onmouseout="tooltip.hide();"><a href='<?php if($d['linkto'])   echo $d['linkto']; else echo url("archive/show/aid/$d[$primary_key]",false);?>' target="_blank" title="查看动态页面" target="_blank" class="a_view"></a></span>

<span class="hotspot" onmouseover="tooltip.show('点击编辑内容！');" onmouseout="tooltip.hide();"><a href="<?php echo modify("act/edit/table/$table/id/$d[$primary_key]");?>" class="a_edit"></a></span>
