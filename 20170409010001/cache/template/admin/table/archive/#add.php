...
<span class="hotspot" onmouseover="tooltip.show('文章置顶,可按栏目或全站置顶！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
 ...
 <input id="color" name="color" type="hidden" /><span class="hotspot" onmouseover="tooltip.show('标题文字颜色！');" onmouseout="tooltip.hide();"><img id="color_btn" width="14" height="14" src="images/admin/colorpicker.png" style="cursor:pointer;" /></span>  <span class="hotspot" onmouseover="tooltip.show('标题加粗！');" onmouseout="tooltip.hide();"><input name="strong" type="checkbox" value="1" <?php if($data['strong']==1) { ?>checked<?php } ?> /></span></td>
    </tr>
 <tr>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="float:left; margin-left:10px; margin-right:5px;">
</span>
</td>
    </tr>
    <tr>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px;">
</span>
<div class="blank10"></div>

            <input type="hidden" name="attachment_id"  id="attachment_id" value="<?php echo archive_attachment(@$data['aid'],'id');?>"  class="input" />
            附件名称：<input type="text" name="attachment_intro"  id="attachment_intro" value="<?php echo archive_attachment(@$data['aid'],'intro');?>" class="input" /><span class="hotspot" onmouseover="tooltip.show('填附件的下载提示名称！');" onmouseout="tooltip.hide();">
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
<div class="blank10"></div>
...
<input type="button"  name="filebuttonUpload"  id="filebuttonUpload" onclick="return ajaxFileUpload('fileupload','<?php echo url("tool/uploadfile",false);?>','#uploading');" value="上传" class="btn_a" />
