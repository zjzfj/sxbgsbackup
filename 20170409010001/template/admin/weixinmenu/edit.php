...
<div id="tagstitle"> <a class="hover">添加一级菜单</a> </div>
  ...
  <div id="tagscontent" class="right_box">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
      <tr class="s_out" >
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="name" id="name" value="{$data[name]}" class="input" /></td>
      </tr>
      <tr class="s_out" >
        <td width="19%" align="right">排序</td>
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="sort" id="sort" value="{$data[sort]}" class="input" /></td>
      </tr>
      <tr class="s_out" >
		...
		<span class="hotspot" onmouseover="tooltip.show('设置为菜单则可以用于添加二级菜单，点击此菜单将会展开二级菜单');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
		</span>
		...
		<dl>
			<dt><div class="blank10"></div></dt>
			<dd>
				<input name='num' type='text'  value='{$data[num]}' class="input" onfocus="if(this.value=='填写推送内容条数，最多10条！') {this.value=''}" onblur="if(this.value=='') this.value='填写推送内容条数，最多10条！'" /><span class="hotspot" onmouseover="tooltip.show('填写推送内容条数，最多10条！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div>
        <?php
...
<div class="img_upload">
                <input type="text" name="pic[]" id="pic{$i}"   class="input"  value='{$tmp[2]}' class="input" onfocus="if(this.value=='请填写图片调用地址') {this.value=''}" onblur="if(this.value=='') this.value='请填写图片调用地址'" /><a href='javascript:deletdisplayimg({$i});' class='displayimg_del'><img src="{$skin_path}/images/no.gif" width="12" height="12" style="margin:2px 20px 0px 10px;" /></a><span class="hotspot" onmouseover="tooltip.show('填写图片调用地址！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin: -3px 5px 0px 0px; /"></span>
			...
			<dl>
				<dt><div class="blank10"></div></dt>
				<dd style='position:relative;'>
					<input name='twname[]' type='text'  class="input"  value='{$tmp[0]}' class="input" onfocus="if(this.value=='请填写内容标题！') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容标题！'" /><span class="hotspot" onmouseover="tooltip.show('填写内容标题！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
			<dl>
				<dt><div class="blank10"></div></dt>
				<dd style='position:relative;'>
				<input name='twurl[]' type='text' value='{$tmp[1]}'  class="text nonull input" onfocus="if(this.value=='请填写内容链接') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容链接'" /><span class="hotspot" onmouseover="tooltip.show('填写内容链接！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
            <?php
			if($i == 1){
		...
		<dl>
			<dt><div class="blank10"></div></dt>
			<dd>
				<input name='twurl[]' type='text' value="{$data['url']}"  class="text nonull input" onfocus="if(this.value=='请填写内容链接地址！') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容链接地址！'" /><span class="hotspot" onmouseover="tooltip.show('请填写内容链接地址！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div></td>
      </tr>
