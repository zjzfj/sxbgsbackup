...
<td align="center"><?php echo cut($d['userid']);?></td>
<td align="center" style="padding-left:10px;"><?php echo cut($d['username']);?></td>
<td align="center" style="padding-left:10px;"><?php echo cut($d['nickname']);?></td>
<td align="center" style="padding-left:10px;"><?php echo usergroupname($d['groupid']);?></td>
...
<?php if($d['isblock']) { ?><a href="<?php echo modify("act/block/table/$table/id/$d[$primary_key]");?>" class="btn_a">解冻</a>
<?php } else { ?>
