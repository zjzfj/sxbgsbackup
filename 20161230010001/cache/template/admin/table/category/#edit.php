...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('parentid',$form,$field,$data);?><span class="hotspot" onmouseover="tooltip.show('如果为一级栏目，不需选择！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>

<tr>
<td width="149" align="right">栏目名称</td>
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('catname',$form,$field,$data,'class="input"');?>
<span class="hotspot" onmouseover="tooltip.show('请填写栏目名称！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>

<tr>
<td width="149" align="right">栏目副标题</td>
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('subtitle',$form,$field,$data,'class="input"');?>
<span class="hotspot" onmouseover="tooltip.show('栏目自定义副标题！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>
...
<td width="1%">&nbsp;</td>
<td>
<?php echo form::getform('htmldir',$form,$field,$data,'123 class="input"');?><span class="hotspot" onmouseover="tooltip.show('目录必须是英文名，留空则自动使用拼音名，请勿夹杂符号！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>

<tr>
<td width="149" align="right">在导航中显示</td>
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('isnav',$form,$field,$data);?>  <span class="hotspot" onmouseover="tooltip.show('如果是一级目录，可选择是否在导航中显示栏目名称和链接！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>

<tr>
<td width="149" align="right">在手机版中显示</td>
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('ismobilenav',$form,$field,$data);?>  <span class="hotspot" onmouseover="tooltip.show('如果是一级目录，可选择是否在导航中显示栏目名称和链接！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>
...
<td width="1%">&nbsp;</td>
<td>	
<?php echo form::getform('meta_title',$form,$field,$data,'class="input"');?>
...
<td width="1%">&nbsp;</td>
<td>
<?php echo form::getform('keyword',$form,$field,$data,'class="input"');?>
...
<input name="htmlrule1" type="text" class="input" value="<?php echo $data['htmlrule'];?>" />
<span class="hotspot" onmouseover="tooltip.show('<strong>默&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;认：</strong>&#123;$caturl&#125;/&#123;$page&#125;.html <br /><strong>短&nbsp;&nbsp;目&nbsp;&nbsp;录：</strong>&#123;$dir&#125/&#123;$page&#125;.html<br /><strong>自&nbsp;&nbsp;定&nbsp;&nbsp;义：</strong>自定义（英文或拼音）/&#123;$page&#125;.html<br /><strong>栏目目录：</strong>&#123;$caturl&#125;<br /><strong>当前目录：</strong>&#123;$dir&#125;<br /><strong>注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意：</strong>&#123;$page&#125;必须存在URL内且为最后！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"> </span>
<div class="blank10"></div>
<font color=gray>如有分页，请一定要在自定义名称后加入分页函数_<b>{</b>$page<b>}</b>！</font>
<div class="blank30"></div>

<?php echo form::getform('htmlrule',$form,$field,$data,'class="input"');?>
<span class="hotspot" onmouseover="tooltip.show('<strong>默&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;认：</strong>&#123;$caturl&#125;/&#123;$page&#125;.html <br /><strong>短&nbsp;&nbsp;目&nbsp;&nbsp;录：</strong>&#123;$dir&#125/&#123;$page&#125;.html<br /><strong>自&nbsp;&nbsp;定&nbsp;&nbsp;义：</strong>自定义（英文或拼音）/&#123;$page&#125;.html<br /><strong>栏目目录：</strong>&#123;$caturl&#125;<br /><strong>当前目录：</strong>&#123;$dir&#125;<br /><strong>注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意：</strong>&#123;$page&#125;必须存在URL内且为最后！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>		
</td>
</tr>
...
<input name="listhtmlrule1" type="text" class="input" value="<?php echo $data['listhtmlrule'];?>" />
<span class="hotspot" onmouseover="tooltip.show('<strong>默&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;认：</strong>&#123;$caturl&#125;/&#123;$page&#125;.html <br /><strong>短&nbsp;&nbsp;目&nbsp;&nbsp;录：</strong>&#123;$dir&#125/&#123;$page&#125;.html<br /><strong>自&nbsp;&nbsp;定&nbsp;&nbsp;义：</strong>自定义（英文或拼音）/&#123;$page&#125;.html<br /><strong>栏目目录：</strong>&#123;$caturl&#125;<br /><strong>当前目录：</strong>&#123;$dir&#125;<br /><strong>注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意：</strong>&#123;$page&#125;必须存在URL内且为最后！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"> </span>
<div class="blank10"></div>
<font color=gray>如有分页，请一定要在自定义名称后加入分页函数_<b>{</b>$page<b>}</b>！</font>
<div class="blank30"></div>

<?php echo form::getform('listhtmlrule',$form,$field,$data,'class="input"');?>
<span class="hotspot" onmouseover="tooltip.show('<strong>默&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;认：</strong>&#123;$caturl&#125;/&#123;$page&#125;.html <br /><strong>短&nbsp;&nbsp;目&nbsp;&nbsp;录：</strong>&#123;$dir&#125/&#123;$page&#125;.html<br /><strong>自&nbsp;&nbsp;定&nbsp;&nbsp;义：</strong>自定义（英文或拼音）/&#123;$page&#125;.html<br /><strong>栏目目录：</strong>&#123;$caturl&#125;<br /><strong>当前目录：</strong>&#123;$dir&#125;<br /><strong>注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意：</strong>&#123;$page&#125;必须存在URL内且为最后！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"> </span>
</td>
</tr>
...
<input name="showhtmlrule1" type="text" class="input" value="<?php echo $data['showhtmlrule'];?>" /><span class="hotspot" onmouseover="tooltip.show('<strong>默&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;认：</strong>&#123;$caturl&#125;/show_&#123;$aid&#125;(_&#123;$page&#125;).html<br /><strong>短&nbsp;&nbsp;目&nbsp;&nbsp;录：</strong>&#123;$dir&#125/show_&#123;$aid&#125;(_&#123;$page&#125;).html<br /><strong>自&nbsp;&nbsp;定&nbsp;&nbsp;义：</strong>自定义（英文或拼音）/&#123;$page&#125;.html<br /><strong>栏目目录：</strong>&#123;$caturl&#125;<br /><strong>当前目录：</strong>&#123;$dir&#125;<br /><strong>注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意：</strong>&#123;$page&#125;必须存在URL内且为最后！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
<div class="blank10"></div>
<font color=gray>如有分页，请一定要在自定义名称后加入分页函数_<b>{</b>$page<b>}</b>！</font>
<div class="blank30"></div>
<?php echo form::getform('showhtmlrule',$form,$field,$data,'class="input"');?>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('isshow',$form,$field,$data);?>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('attr3',$form,$field,$data,'class="input_c"');?>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('ecoding',$form,$field,$data,'class="input"');?>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('includecatarchives',$form,$field,$data);?>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('linkto',$form,$field,$data,'class="input"');?>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('image',$form,$field,$data);?>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::input('thumb_width',$data['thumb_width'],'size="5" class="input_c"');?> px × <?php echo form::input('thumb_height',$data['thumb_height'],'size="5" class="input_c"');?> px
<span class="hotspot" onmouseover="tooltip.show('默认: <?php echo type::getwidthofthumb(get('id'));?> px × <?php echo type::getheightofthumb(get('id'));?> px！');" onmouseout="tooltip.hide();">
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
</td>
</tr>
