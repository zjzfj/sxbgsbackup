...
class template_admin extends admin {
    ...
    function downlist_action(){
        $str = file_get_contents('http://template.cmseasy.cn/template.html');
    ...
    function down_action(){
        ...
        if($size < 1){
            $res = array(
                'code' => 1,
                'msg' => '<div id="message"><div id="message_bg"><img src="./images/admin/ico_11.gif" />&nbsp;模板下载失败</div><div id="message_bt"></div></div>',
            );
        }else{
            ...
            $res = array(
                'code' => 0,
                'msg' => '<div id="message"><div id="message_bg"><img src="./images/admin/ico_11.gif" />&nbsp;模板安装成功</div><div id="message_bt"></div></div>',
            );
