...
<tr>
<td width="149" align="right">分类副标题</td>
<td width="1%">&nbsp;</td>
<td>{form::getform('subtitle',$form,$field,$data,'class="input"')}
<span class="hotspot" onmouseover="tooltip.show('分类自定义副标题！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>
