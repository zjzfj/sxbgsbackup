...
　　总结：其实关于网站改版而言，我们更多的照样需求留意到一些细节性的任务，更好的尊于用户体验的原则结构合理的网站，然后进行优化在到后期的推行恢复任务，这些都不是一朝一夕就可以完成的，照样需求我们有一颗好的心态积极的去面临。只要如许我们的网站才干做好，做强做大。',
  ...
  array (
    ...
    'catid' => '13',
    'typeid' => '0',
    'title' => '<font style="color:;">四川大学华西广安医院院长王光林深入呼吸内科调研</font>',
    'tag' => '',
    'username' => 'admin',
    'userid' => '1',
    'view' => '1',
    ...
    'state' => '1',
    'checked' => '1',
    'introduce' => '对于我们优化人员来说，在每一个网站建设之初我们都在想我们的网站在优化竞争中赢在起跑线上。为此在建站之初，网站的结构是否有利于我们的优化是我们不得不考虑的一件重要的事情。对于一个好的网站结构来说，它不仅可以对你的排名起到很好的促进作用，对于你的投资回报率提高来说也有很好的作用。如果你的站点有一个用关键词构架的优化结构的话，那么对于你的优化来说将起到事半功倍的效果。我们可以将关键词区分为主关键词、次关键词和长尾关键词，这三种都有各自的优势，那么本文将围绕着这三种关键词阐述如何构建你的站点的优化结构，来使你的站点获得更高的排名和点击率，达到利益的最大化。
...
　　如何让自己的站点赢在起跑线上，是每一优化人员都在苦心琢磨的问题，但其实从最基本的网站的构架就可以有很大的作用，希望本文对大家有所帮助。',
    ...
    'catname' => '新闻动态',
    'caturl' => '/index.php?case=archive&act=list&catid=13',
    'stitle' => '四川大学华西广安医院院长王光林深入呼吸内科调研',
    'strgrade' => '<img src="/images/admin/star2.gif" border="0" /><img src="/images/admin/star2.gif" border="0" /><img src="/images/admin/star2.gif" border="0" /><img src="/images/admin/star2.gif" border="0" /><img src="/images/admin/star2.gif" border="0" />',
