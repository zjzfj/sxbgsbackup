...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('catid',$form,$field,$data);?>
...
<input id="color" name="color" type="hidden" /><span class="hotspot" onmouseover="tooltip.show('标题文字颜色！');" onmouseout="tooltip.hide();"><img id="color_btn" width="14" height="14" src="images/admin/colorpicker.png" style="cursor:pointer;" /></span>  <span class="hotspot" onmouseover="tooltip.show('标题加粗！');" onmouseout="tooltip.hide();"><input name="strong" type="checkbox" value="1" <?php if($data['strong']==1) { ?>checked<?php } ?> /></span>
</td>
    </tr>
<tr>
        <td width="149" align="right">副标题</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('subtitle',$form,$field,$data,'class="input"');?><span class="hotspot" onmouseover="tooltip.show('内容自定义副标题！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
 ...
 <tr>
   ...
   <!--<select id='tag_option'>
     <option value="0">请选择tag标签</option>
             <?php if(is_array($tag_opton) && !empty($tag_opton))
foreach($tag_opton as $t) { ?>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><input type="text" name="adddate" id="adddate" value="<?php echo $data['adddate'];?>" class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布时间，可自定义，格式：2010-08-08 08:08:08！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
<tr>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><input type="text" name="author" id="author" value="<?php echo $data['author'] ?>"   class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布作者名，可自定义！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
...
<span class="hotspot" onmouseover="tooltip.show('你可以自定生成文件名称<br />例如：abc.html<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>{</b>$caturl<b>}</b>/abc.html<br />默认：<b>{</b>$caturl<b>}</b>/show_<b>{</b>$aid<b>}</b>(_<b>{</b>$page<b>}</b>).html<br /><b>{</b>$caturl<b>}</b> = 栏目目录<br /><b>{</b>$aid<b>}</b> = 内容ID<br /><b>{</b>$page<b>}</b> = 内容分页值！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <tr>
        <td width="149" align="right">颜色</td>
        <td width="1%">&nbsp;</td>
...
<td width="1%">&nbsp;</td>
<td><?php echo form::getform('isecoding',$form,$field,$data);?>
...
?>
<div id="pics<?php echo $ic;?>_up" style="clear:both;"><span id="pics<?php echo $ic;?>_preview"><img width="150" style="width:150px;" src="<?php echo $v['url'];?>" border="0" /></span><div class="blank10"></div><input id="pics<?php echo $ic;?>" value="<?php echo $v['url'];?>" class="input" name="pics[<?php echo $ic;?>][url]" style="float:left;" />
<input style="float:left;" id="pics<?php echo $ic;?>_del" onclick="pics_delete('<?php echo $ic;?>','pics');" value="" type="button" name="delbutton" class="a_del" />
<div class="blank10"></div>
<input id="pics<?php echo $ic;?>alt" value="<?php echo $v['alt'];?>" class="input" name="pics[<?php echo $ic;?>][alt]" style="float:left;" /> 
...
}?></div><input type="hidden" name="ic" id="ic" value="<?php echo $ic;?>" />
    <div class="blank10"></div>
