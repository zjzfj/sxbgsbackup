...
<div class="top2-2">
<ul>
<li><a class="<?php if($topid==0) { ?> on<?php } ?>" href="<?php echo $base_url;?>/"><?php echo lang(homepage);?></a>
<?php foreach(categories_nav() as $t) { ?></li>
<li><a class="<?php if(isset($topid) && $topid==$t['catid']) { ?> on<?php } ?>" href="<?php echo $t['url'];?>" target="<?php if(config::get('nav_blank')==1) { ?> _blank<?php } ?>"><?php echo $t['catname'];?></a></li>
<?php } ?>
</ul>
</div>
</div>
...
<div class="top3">
<div class="box">
<div class="top3-1" style="border:none;">
<?php echo templatetag::tag('页头栏目子栏目一');?>
</div>
<div class="top3-1">
<?php echo templatetag::tag('页头栏目子栏目二');?>
</div> 
<div class="top3-1">
<?php echo templatetag::tag('页头栏目子栏目三');?>
</div> 
<div class="top3-1">
<?php echo templatetag::tag('页头栏目子栏目四');?>
</div> 
<div class="top3-1">
<?php echo templatetag::tag('页头栏目子栏目五');?>
</div> 
<div class="top3-1">
<?php echo templatetag::tag('页头栏目子栏目六');?>
</div> 
<div class="top3-1">
<?php echo templatetag::tag('页头栏目子栏目七');?>
</div> 
<div class="clear"></div>
</div>
</div>
