...
array(
		...
		//标签
		array('tags_wap_(.*?)_(\d+)\.htm$','tag/show/t/wap/tag/$1/page/$2'),
		...
		//专题
		array('speciallist_(\d+)\.htm$','special/show/spid/$1'),
		array('speciallist_(\d+)_(\d+)\.htm$','special/show/spid/$1/page/$2'),
		...
		//标签
		array('tags_(.*?)_(\d+)\.htm$','tag/show/tag/$1/page/$2'),
