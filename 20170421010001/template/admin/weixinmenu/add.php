  ...
  <div id="tagscontent" class="right_box">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
      ...
      <tr class="s_out" >
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%"><input type="text" name="sort" id="sort" value="" class="input" /></td>
      </tr>
      <tr class="s_out" >
       ...
       <span class="caidantype_1 ">
		...
		<dl>
			...
			<dd><div class="blank10"></div>
				<input name='num' type='text' value='填写推送内容条数，最多10条！' class="input" onfocus="if(this.value=='填写推送内容条数，最多10条！') {this.value=''}" onblur="if(this.value=='') this.value='填写推送内容条数，最多10条！'" /><span class="hotspot" onmouseover="tooltip.show('填写推送内容条数，最多10条！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div>
...
<div class="blank10"></div>
                <input type="text" name="pic[]" id="pic1" class="input"  value='请填写图片调用地址' class="input" onfocus="if(this.value=='请填写图片调用地址') {this.value=''}" onblur="if(this.value=='') this.value='请填写图片调用地址'" /><span class="hotspot" onmouseover="tooltip.show('填写图片调用地址！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			...
			<div class="blank10"></div>
				<dd style='position:relative;'>
					<input name='twname[]' type='text' class="input"  value='请填写内容标题' class="input" onfocus="if(this.value=='请填写内容标题') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容标题'" /><span class="hotspot" onmouseover="tooltip.show('填写内容标题！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
				<input name='twurl[]' type='text' class='text nonull input'  class="input"  value='请填写内容链接' class="input" onfocus="if(this.value=='请填写内容链接') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容链接'" /><span class="hotspot" onmouseover="tooltip.show('填写内容链接！');" onmouseout="tooltip.hide();"><img src="{$base_url}/images/admin/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
			<dl>
				<div class="blank10"></div>
