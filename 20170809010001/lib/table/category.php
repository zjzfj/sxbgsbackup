...
class category extends table {
    ...
    function getcols($act) {
        if ($act == 'modify')
            return 'catid,catname,parentid,htmldir,template,listtemplate,showtemplate,showform,ishtml,isshow,ispages,includecatarchives,linkto,meta_title,htmlrule,listhtmlrule,showhtmlrule,categorycontent,image,thumb_width,thumb_height,description,keyword,scategory,isnav,attr3';
